...
- **Atribuído a (próxima tarefa)**: além do "Analista responsável" (fixo, é de quem é o job), cada job tem um campo separado **Atribuído a**, indicando quem está com a próxima tarefa/passo no momento — pode ser qualquer analista/estagiária cadastrada ou "Gestão". Dá pra mudar a qualquer momento editando o job, e o card mostra uma etiqueta 📌 com o nome de quem está atribuído (some quando ninguém está atribuído). Pensado pra dupla analista + estagiária de cada praça se organizarem sobre quem toca cada job a seguir, com a gestão também podendo puxar um job pra si.
